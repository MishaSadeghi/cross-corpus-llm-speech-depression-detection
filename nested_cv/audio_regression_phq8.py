...
LABELS_CSV = Path("CONFIGURE_ME/labels/regress_labels_phq8.csv")

# v2: all four sources (v1 used only wav2vec_non_diarised — kept as comment):
# FEATURES_CSV = FEATURES_BASE / "proposed_dataset_german_xlsr_non_diarised/proposed_dataset_german_xlsr_non_diarised.csv"
AUDIO_SOURCES = {
...
OUTPUT_BASE = Path("CONFIGURE_ME/repo/Audio/maximal_regression_v2_phq8")
